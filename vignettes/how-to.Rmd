...
suitable for settings where these curves are only sparsly and irregularly observed. 
...
the following command in R console:
...
```{r}
digit3 <- apply(digit3, MARGIN = 3, FUN = function(curve){
...
```{r fig1, fig.height = 3.5, fig.width = 7, fig.align = "center"}
par(mfrow=c(1, 2))
plot(mean_smooth)
plot(mean_poly, col = "blue")
```
